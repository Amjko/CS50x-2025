...
char *get_nameJPEG(int index)
{
    ...
    // Use local variable
    // if (index_length == 1)
    //     sprintf(name, "%s/00%d.jpeg", RECOVERY_DIR, index);
    // else if (index_length == 2)
    //     sprintf(name, "%s/0%d.jpeg", RECOVERY_DIR, index);
    // else if (index_length == 3)
    //     sprintf(name, "%s/%d.jpeg", RECOVERY_DIR, index);
    if (index_length == 1)
        sprintf(name, "00%d.jpg", index);
    else if (index_length == 2)
        sprintf(name, "0%d.jpg", index);
    else if (index_length == 3)
        sprintf(name, "%d.jpg", index);
