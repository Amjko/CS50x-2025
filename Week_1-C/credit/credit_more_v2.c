/**
 * credit_more_v2.c -> Determine credit card type
 * Creation:           January 04, 2025
 * 
 ...
 * 
 * Note:    Difference of version 2 from version 1 is the
 *          usage of separate functions for different
 *          parts of the program's process.
 * 
 * Usage: ./credit_more_v2.c
 * 
 * Output: 
